  ...
  <body>
	...
	<div class="container" style="margin-bottom:100px;">
		...
		<div class="comment-form-wrap pt-5">
                ...
                <form action="insertRecipe" method="post" style="width:60%">
					<div class="form-group">
						<label for="website">Select Product *</label>
						<div class="wrapper">
						<select id="cars" name="product_id" style="height:60px;overflow:scroll; " class="form-control" Required>
							<%
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="website" name="description" required>
                  </div>
                  <div class="form-group">
                    <input type="submit" value="Insert Recipe" class="btn btn-primary btn-md">
                  </div>
                </form>
              </div>
            </div>
