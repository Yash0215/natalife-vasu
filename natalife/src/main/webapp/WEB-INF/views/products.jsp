...
<%@ page import="java.util.List,com.group.project.natalife.model.Product,com.group.project.natalife.model.Cart,java.lang.*" %>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <!-- END header -->
    <div class="col-md-12 text-center heading-wrap-other" style ="margin-bottom:40px;margin-top:20px;">
        <h2>Our Products</h2>
    </div>
