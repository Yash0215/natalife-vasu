...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
		  ...
		  <ul class="navbar-nav ml-auto">
              <li class="nav-item cta-btn-other">
					<a class="nav-link" href="login">Already A User? Login Here.</a>
              </li>
          </ul>
        </div>
      </nav>
    ...
    <div class="container" style="text-align: center">	
		<a class="description" style="color:red">${message}</a>
		<br>
		<form action="signup" method="post" style="border:1px solid #909190" class="sign-up-form">
			<div class="form-group"><input type="text" class="form-input" placeholder="First Name" name="fname" required></div>
			<div class="form-group"><input type="text" class="form-input" placeholder="Last Name" name="lname" required></div>
			...
			<div class="form-group"><input type="password" class="form-input" placeholder="Confirm Password" name="rpassword" required></div>
