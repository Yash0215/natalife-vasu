...
/* page-ms */
.page-ms {transform: translateY(-250px);}
...
<div class="container" >
	<div  class="error">
		...
		<div class="page-ms">
			<p class="page-msg"> Oops, the page you're looking for is not found. </p>
			<a href = "../../index"><button class="go-back" href="../../index">Go Home</button></a>
		</div>
	</div>
</div>