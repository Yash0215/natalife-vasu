  ...
  <body>
	...
	<div class="container" style="margin-bottom:100px;">
		...
		<div class="comment-form-wrap pt-5">
                ...
                <form action="insertProduct" method="post" enctype="multipart/form-data" style="width:60%">
				  ...
				  <div class="form-group">
                    ...
                    <input type="file" accept="image/*" name="image" src="MainUpload.png" class="form-control"/>  
                  </div>
                  <div class="form-group">
